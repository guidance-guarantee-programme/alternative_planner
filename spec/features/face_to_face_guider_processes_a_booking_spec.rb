...
RSpec.feature 'Face-to-face guider processes a booking' do
  scenario 'Successfully processing a booking', js: true do
    given_the_user_identifies_as(:face_to_face_guider) do
      and_an_unprocessed_booking_exists
  ...
  def and_an_unprocessed_booking_exists
